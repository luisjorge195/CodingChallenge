...
const Login = () => {
    ...
    return (
        <div className="flex h-screen md:bg-[url('./src/assets/galery.jpg')] bg-cover ">
            <div className="m-auto bg-black opacity-80 brigthnes-60 p-10">
                ...
                <form className="mt-10" onSubmit={(e)=>handleSubmit(e, setAlerta)}>
                    <div className="">
                        <label className=" uppercase text-white block text-xl font-bold">Email</label>
                        <input 
                    ...
                    <div className="my-5">
                        <label className="uppercase text-white block text-xl font-bold">Pasword</label>
                        <input 
